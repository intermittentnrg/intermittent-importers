...
module AemoNem
  ...
  class Trading < Base
    ...
    def add_csv csv
      csv.select { |row| row[0..2] == ['D','TRADING','PRICE'] }.each do |row|
        # I
        # TRADING
        # PRICE
        # 3
  ...
  class Dispatch < Base
    ...
    def add_csv csv
      ...
      csv.select { |row| row[0..2] == ['D', 'DISPATCH', 'INTERCONNECTORRES']}.each do |row|
        #0:I
        #1:DISPATCH
        #2:INTERCONNECTORRES
        #3:3
      ...
      csv.select { |row| row[0..2] == ['D','DISPATCH','REGIONSUM'] }.each do |row|
        #I
        #DISPATCH
        #REGIONSUM
        #7
  ...
  class Scada < Base
    ...
    def add_csv csv
      ...
      logger.benchmark_info("parse csv") do
        csv.select { |row| row[0..2] == ['D','DISPATCH','UNIT_SCADA'] }.each do |row|
          # I
          # DISPATCH
          # UNIT_SCADA
          # 1
  ...
  class DuDetail < Base
    ...
    def add_csv csv
      logger.benchmark_info("parse csv") do
        ...
        csv.select { |row| row[0..2] == ['D','PARTICIPANT_REGISTRATION','DUDETAIL'] }.each do |row|
          #I
  ...
  class RooftopPv < Base
    ...
    def add_csv csv
      csv.select { |row| row[0..2] == ['D','ROOFTOP','ACTUAL'] && row[8] == 'MEASUREMENT' }.each do |row|
        # I
        # ROOFTOP
        # ACTUAL
        # 2
