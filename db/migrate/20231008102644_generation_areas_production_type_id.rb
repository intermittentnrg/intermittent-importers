...
#UPDATE generation g SET areas_production_types_id=(SELECT id FROM areas_production_types apt WHERE g.area_id=apt.area_id AND g.production_type_id=apt.production_type_id)
  end
end
