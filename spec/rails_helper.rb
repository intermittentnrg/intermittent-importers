...
abort("The Rails environment is running in #{Rails.env.to_s} mode!") unless Rails.env.test?
require 'rspec/rails'
...
VCR.configure do |config|
  ...
  config.ignore_hosts '127.0.0.1', 'localhost', ENV['ES_HOST'], URI(ENV['SELENIUM_URL']).host
